                            ...
                            IconButton(
                              onPressed: () {
                                AppCubit.get(context)
                                    .changeWidgetVisibility(one: true);
                              },
                              icon: Icon(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Icon(
                                  Icons.circle,
                                  color: Color.fromRGBO(186, 21, 92, 0.655),
                                  size: 13,
                                ),
                                SizedBox(
                                  width: 10,
                        ...
                        child: Column(
                          children: [
                            ...
                            IconButton(
                              onPressed: () {
                                AppCubit.get(context)
                                    .changeWidgetVisibility(two: true);
                              },
                              icon: Icon(
                                Icons.keyboard_arrow_down,
                                size: 35,
                        ...
                        child: Column(
                          children: [
                            ...
                            IconButton(
                              onPressed: () {
                                AppCubit.get(context)
                                    .changeWidgetVisibility(three: true);
                              },
                              icon: Icon(
                                Icons.keyboard_arrow_down,
                                size: 35,
                        ...
                        child: Column(
                          children: [
                            ...
                            IconButton(
                              onPressed: () {
                                AppCubit.get(context)
                                    .changeWidgetVisibility(five: true);
                              },
                              icon: Icon(
                                Icons.keyboard_arrow_down,
                                size: 35,
