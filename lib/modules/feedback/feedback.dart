                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Welcome To Our Feedback Page',style: TextStyle(color: Colors.white, fontSize: 18),),
                    ...
                    Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Color.fromRGBO(200, 59, 139, 0.655),
                        ),
                        child: MaterialButton(
                          onPressed: (){
                            if(formKey.currentState!.validate()) {
                              sendEmail(feedBack.text, 'Feedback message ', 'm0stafarihan5@gmail.com');
                            }
                          },
