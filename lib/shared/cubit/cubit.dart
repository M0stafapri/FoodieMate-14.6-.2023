...
import 'package:graduation_project/modules/program/Program.dart';
import 'package:graduation_project/modules/program/requests_screen.dart';
  ...
  Widget float1(context) {
    return Container(
      child: FloatingActionButton(
        onPressed: () {
          navigateTo(context, Program());
        },
        heroTag: "btn1",
        tooltip: 'Request Here',
...
// multipart that takes file
  ...
  bool TwoVisible = false;
  bool ThreeVisible = false;
  bool FourVisible = false;
  bool FiveVisible = false;
...
})
{
  if(one??false)
    ...
    {
      FourVisible=!FourVisible;
      emit(AppChangeWidgetVisibilityState());
    }
  else if (five??false)
    {
      FiveVisible=!FiveVisible;
      emit(AppChangeWidgetVisibilityState());
    }
